...
import com.cbitss.careforu.data.ServiceUtils;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseUser;
import com.cbitss.careforu.data.StaticConfig;
import com.cbitss.careforu.ui.FriendsFragment;
import com.cbitss.careforu.ui.GroupFragment;
import com.cbitss.careforu.ui.LoginActivity;
import com.cbitss.careforu.ui.UserProfileFragment;
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    // User is signed in
                    startActivity(new Intent(MMainActivity.this, LoginActivity.class));
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ServiceUtils.stopServiceFriendChat(MMainActivity.this.getApplicationContext(), false);
                if (adapter.getItem(position) instanceof FriendsFragment) {
                    floatButton.setVisibility(View.VISIBLE);
                    floatButton.setOnClickListener(((FriendsFragment) adapter.getItem(position)).onClickFloatButton.getInstance(MMainActivity.this));
                    floatButton.setImageResource(R.drawable.plus);
                } else if (adapter.getItem(position) instanceof GroupFragment) {
                    floatButton.setVisibility(View.VISIBLE);
                    floatButton.setOnClickListener(((GroupFragment) adapter.getItem(position)).onClickFloatButton.getInstance(MMainActivity.this));
